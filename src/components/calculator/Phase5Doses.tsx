    ...
    <Card className="w-full max-w-6xl mx-auto">
      <CardHeader>
        <CardTitle className="flex items-center gap-4">
          ...
          {isEs ? "Fase 5 - Dosis necesarias" : isEn ? "Phase 5 - Doses Needed" : "Fase 5 - Doses necessárias"}
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-8">
        <div>
          <h3 className="text-lg font-semibold mb-4">{isEs ? "Dosis necesarias" : isEn ? "Doses needed" : "Doses necessárias"}</h3>
            ...
            <table className="w-full border-collapse border border-gray-300">
              <thead>
                <tr className="bg-black text-white">
                  ...
                  <th className="border border-gray-300 p-2 text-center">{isEs ? "Anual" : isEn ? "Annual" : "Anual"}</th>
                  <th className="border border-gray-300 p-2 text-center">{isEs ? "Mensual" : isEn ? "Monthly" : "Mensal"}</th>
                  <th className="border border-gray-300 p-2 text-center">{isEs ? "Semanal" : isEn ? "Weekly" : "Semanal"}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                ...
                <tr>
                  <td className="border border-gray-300 p-2 font-semibold">{isEs ? "Dosis de carne" : isEn ? "Beef doses" : "Doses de corte"}</td>
